#!/bin/bash
# 使用 webapp-testing skill 进行 Account Render Error 修复的完整测试
# [2025-01-30 20:00:00]

set -e

echo "============================================================"
echo "🧪 测试 Account Render Error 修复"
echo "============================================================"
...
if [ "$BACKEND_RUNNING" = "no" ] || [ "$FRONTEND_RUNNING" = "no" ]; then
    ...
    echo "   python3 test-account-render-error-fix.py http://localhost:3000"
