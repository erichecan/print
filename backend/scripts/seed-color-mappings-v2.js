...
const PRODUCTION_COLORS = [
    { name: 'Aloe', hex: '#8FB58E', externalId: '900001' },
    { name: 'Amethyst', hex: '#6C4F76', externalId: '900002' },
    { name: 'Anthracite', hex: '#292C2F', externalId: '900003' },
    { name: 'Antique Cherry Red', hex: '#811E36', externalId: '176115' },
    { name: 'Antique Heliconia', hex: '#943962', externalId: '176135' },
    { name: 'Antique Irish Green', hex: '#006C35', externalId: '900004' },
    { name: 'Antique Jade Dome', hex: '#005D55', externalId: '900005' },
    { name: 'Antique Orange', hex: '#C24E3A', externalId: '900006' },
    { name: 'Antique Royal', hex: '#2E4369', externalId: '900007' },
    { name: 'Antique Sapphire', hex: '#007D9E', externalId: '176121' },
    { name: 'Apple Green', hex: '#8DB600', externalId: '900008' },
    { name: 'Apricot', hex: '#FBB982', externalId: '900009' },
    { name: 'Aqua', hex: '#00FFFF', externalId: '900010' },
    { name: 'Aqua Blue', hex: '#00C4CC', externalId: '900011' },
    { name: 'Aqua Heather', hex: '#80E0E6', externalId: '900012' },
    { name: 'Aqua Tri-Blend', hex: '#66CDAA', externalId: '900013' },
    { name: 'Aquatic', hex: '#4B908E', externalId: '900014' },
    { name: 'Aquatic Blue', hex: '#00849F', externalId: '900015' },
    { name: 'Arctic', hex: '#D0E3E8', externalId: '900016' },
    { name: 'Army', hex: '#4B5320', externalId: '900017' },
