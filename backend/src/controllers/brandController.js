 ...
 * [2025-01-30 10:00:00] 获取指定品牌的其它商品列表，排除当前商品
 */
exports.getBrandProducts = async (req, res) => {
  try {
    ...
    // [2025-01-30 10:00:00] 构建查询条件
    const where = {
      brandId: brandId,
      isActive: true,
    };

    // [2025-01-30 10:00:00] 排除当前商品
    if (excludeProductId) {
      where.id = {
    ...
    // [2025-01-30 10:00:00] 查询商品，按创建时间降序，然后按销量降序
