...
// Request logger (trace ID & structured logging)
app.use(requestLogger);

// Chaos Middleware (Fault Injection) - Safe for non-prod only
...
// Dependency Error Handling (Prisma, Axios, etc.)
app.use(require('./middleware/dependencyErrors'));
