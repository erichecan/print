...
**生成时间**: 2025/12/2 00:26:20
**分析页面**: https://www.customink.com/ndx/#/savedDesigns
**总元素数**: 48

## 1. 页面概览

![全页面截图](screenshots/full-page-2025-12-02T05-24-14.png)
...
- **error**: [OPTIMIZELY] - ERROR 2025-12-02T05:24:09.111Z DatafileManager: Error fetching datafile: Request error
...
### TypeError: Cannot read properties of undefined (reading 'Domain')
    ...
    at v.getLocation (https://cdn.cookielaw.org/scripttemplates/otSDKStub.js?did=ace1330e-5933-47ab-a5e5-75760b69bf0e:1:10512)
    at r.onerror (https://cdn.cookielaw.org/scripttemplates/otSDKStub.js?did=ace1330e-5933-47ab-a5e5-75760b69bf0e:1:13038)
    at XMLHttpRequest.Ya (https://www.customink.com/ndx/assets/vendor-Br5YCbcv.js:378:73224)
    at gs._rollbar_wrapped.gs._rollbar_wrapped (https://www.customink.com/ndx/assets/vendor-Br5YCbcv.js:199:252309)
...
gs._rollbar_wrapped.gs._rollbar_wrapped@https://www.customink.com/ndx/assets/vendor-Br5YCbcv.js:198:252308
```
