/**
* 线下订单 Sales 流程 E2E 测试（登录 + 列表 + 详情 + 未登录重定向）
* 修复：使用相对路径，让 Playwright 自动使用配置中的 baseURL
 */
import { test, expect } from './fixtures/test-base';

// 线下订单 E2E 种子账号（与 backend/scripts/seed-offline-e2e.js 保持一致）
...
// 使用相对路径，Playwright 会自动使用配置中的 baseURL
