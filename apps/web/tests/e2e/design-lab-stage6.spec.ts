...
* 测试 Product Colors 和 Names & Numbers 功能
 */
...
// 如果找不到 Rail 按钮，尝试点击底部操作栏的 "Change Color" 链接
...
// 点击 "Add Names and Numbers" 按钮进入 Tools 页面
...
// 验证画布上是否有文本对象（通过检查 canvas 或 fabric 对象）
