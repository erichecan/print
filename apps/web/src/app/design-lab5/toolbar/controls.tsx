      ...
      <div className="dl-edit-upload-panel__section">
        <div className="dl-edit-upload-panel__controls">
          ...
          <div className="dl-edit-upload-panel__tool-group">
            ...
            <div className="dl-edit-upload-panel__tool-label">Duplicate</div>
          </div>
          ...
          {onCrop && (
            <div className="dl-edit-upload-panel__tool-group">
              <button
                className="dl-edit-upload-panel__control-btn"
                onClick={() => {
                  console.log('[UploadEditControls] Crop button clicked');
                  onCrop && onCrop();
                }}
                type="button"
                aria-label="Crop"
              ...
              <div className="dl-edit-upload-panel__tool-label">Crop</div>
            </div>
          )}
        </div>
      </div>
