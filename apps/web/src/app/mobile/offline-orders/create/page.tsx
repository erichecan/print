...
function OfflineOrdersIntakePageInner({ editId }: { editId?: string }) {
  ...
  if (editForbidden) {
    return (
      <div className="mobile-app min-h-screen bg-slate-50 flex flex-col items-center justify-center px-6 text-center gap-4">
        <div className="text-4xl">🔒</div>
        <h1 className="text-lg font-bold text-slate-900">无法编辑他人的订单</h1>
        <p className="text-sm text-slate-600 leading-relaxed">
          订单 {editOrderData?.orderCode || editId} 由其他同事创建。你可以查看和打印，
