...
interface OrderItemConfiguratorProps {
  productItemId: string; // [2025-12-19] 产品项ID
  colorGroups: OrderItemColorGroup[]; // [2025-12-19] 颜色组列表
  onUpdate: (groups: OrderItemColorGroup[]) => void; // [2025-12-19] 更新回调
  onValidationChange?: (isValid: boolean, errors: string[]) => void; // [2025-12-19] 验证状态变化回调
}
