...
// 查找是否已有该颜色的配置（用于继承）
  ...
  return {
    ...
    quantities,
positions: existingGroup?.positions || [], // 如果已有配置，保留；否则为空
unitPrice: existingGroup?.unitPrice || 0, // 颜色级别的单价
