/**
 * Design Lab 本地存储工具
* 使用localStorage保存设计草稿，替代后端保存
* 扩展：支持多个设计存储、时间筛选、删除功能
 */
'use client';
...
const STORAGE_KEY_DESIGNS = 'designLab:designs'; // 新增：所有设计列表
const CURRENT_VERSION = '1.0.0'; // 当前版本号
...
designId?: string, // 可选：如果提供则更新现有设计
...
// CRITICAL FIX: Save migrated data back to localStorage
